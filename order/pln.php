...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
       ...
       } elseif (!preg_match('/^[0-9]{6,13}$/', $IDTujuan)) {
              $_SESSION['popup_error'] = "ID Pelanggan/Tujuan PLN harus berupa angka 11–12 digit.";
              ...
              <div class="col-lg-6">
                     <div class="bg-custom-card">
                            ...
                            <div id="konten-layanan" class="intruksi-order">
                                   <h2 class="h5 mb-2" id="judul-layanan">Layanan: Token PLN</h2>
                     ...
                     <div class="p-4 bg-white rounded shadow-sm">
                            ...
                            <form id="orderForm" method="POST">
                                   <div class="mb-3 top-20">
                                          ...
                                          <input type="tel" class="form-control" name="IDTujuan" id="IDTujuan" placeholder="ID Pelanggan PLN (11–12 digit)" inputmode="numeric" pattern="\d{11,12}" maxlength="12" required>
                                          <small id="hpError" class="text-danger d-none">Masukan ID Tujuan.</small>
                                   </div>
...
<script>
       ...
       document.getElementById("IDTujuan").addEventListener("input", debounce(function() {
              ...
              if (nomor.length === 0) {
                     container.innerHTML = "";
                     nots.innerHTML = "";
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Masukkan nomor tujuan terlebih dahulu.</p>";
              ...
              if (nomor.length < 2 || nomor.length > 12) {
                     container.innerHTML = "";
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Masukkan nomor tujuan terlebih dahulu.</p>";
                     nots.innerHTML = "";
       ...
       document.addEventListener("DOMContentLoaded", function() {
              ...
              if (produkContainerKosong && noQueryBrand) {
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Masukkan ID Tujuan terlebih dahulu.</p>";
              } else {
