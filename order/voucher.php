        ...
        <div class="col-lg-6">
            <div class="bg-custom-card">
                ...
                <div id="konten-layanan" class="intruksi-order">
                    <h2 class="h5 mb-2" id="judul-layanan">Layanan: Voucher</h2>
                    ...
                    <div class="option-card position-relative" data-value="${produk.id}">
                        ...
                        <div class="info">
                            <div class="nama">
                                ...
                                <div class="produk">${produk.deskripsi.charAt(0).toUpperCase() + produk.deskripsi.slice(1)} ${produk.nama_produk}</div>
                            </div>
