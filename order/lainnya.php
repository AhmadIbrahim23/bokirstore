              ...
              <div class="col-lg-6">
                     <div class="bg-custom-card">
                            ...
                            <div id="konten-layanan" class="intruksi-order">
                                   <h2 class="h5 mb-2" id="judul-layanan">Layanan: STREAMING</h2>
              ...
              <div class="col-lg-6">
                     <div class="p-4 bg-white rounded shadow-sm">
                            ...
                            <form id="orderForm" method="POST">
                                   ...
                                   <?php
                                   $kategori = $_GET['kategori'] ?? 'lainnya';
                                   $brandList = [];
                                   ...
                                   <div class="mb-3 top-20">
                                          <label for="IDTujuan" class="form-label text-dark"><b>1.Nomor Tujuan:</b></label>
                                          <input type="text" class="form-control" name="IDTujuan" id="IDTujuan" placeholder="ID/No Tujuan"  required>
                                          <small id="hpError" class="text-danger d-none">Masukan ID/No Tujuan.</small>
                                   </div>
                                                        ...
                                                        <div class="option-card position-relative" data-value="<?= htmlspecialchars($id) ?>">
                                                               ...
                                                               <div class="info">
                                                                      <div class="nama">
                                                                             ...
                                                                             <div class="produk"><?= htmlspecialchars($nama_produk) ?> | <?= htmlspecialchars($deskripsi) ?></div>
                                                                      </div>
...
<script>
       ...
       document.getElementById("IDTujuan").addEventListener("input", debounce(function() {
              ...
              if (nomor.length === 0) {
                     container.innerHTML = "";
                     nots.innerHTML = "";
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Pilih layanan/Kategori Dan masukan ID/NO tujuan.</p>";
              ...
              if (nomor.length < 2 && !selectedBrand) {
                     container.innerHTML = "";
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Pilih layanan/Katgeori dahulu.</p>";
                     nots.innerHTML = "";
              ...
              if (nomor && selectedBrand) {
                     ...
                     fetchProduk('lainnya', selectedBrand);
              } else if (!nomor) {
                     container.innerHTML = "";
                     productNorsult.innerHTML = "";
       ...
       document.addEventListener("DOMContentLoaded", function() {
              ...
              if (produkContainerKosong && !urlBrand) {
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Pilih layanan/Kategori dahulu.</p>";
              } else {
