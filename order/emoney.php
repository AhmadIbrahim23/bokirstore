              ...
              <div class="col-lg-6">
                     <div class="bg-custom-card">
                            ...
                            <div id="konten-layanan" class="intruksi-order">
                                   <h2 class="h5 mb-2" id="judul-layanan">Layanan: E-Monney</h2>
                     ...
                     <div class="p-4 bg-white rounded shadow-sm">
                            ...
                            <form id="orderForm" method="POST">
                                   ...
                                   <div class="mb-3 top-20">
                                          ...
                                          <input type="tel" class="form-control" name="IDTujuan" id="IDTujuan" placeholder="ID/No Tujuan" inputmode="numeric" required>
...
<script>
       ...
       document.getElementById("IDTujuan").addEventListener("input", debounce(function() {
              ...
              if (nomor.length === 0) {
                     container.innerHTML = "";
                     nots.innerHTML = "";
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Pilih layanan produk Dan masukan ID/NO tujuan.</p>";
              ...
              if (nomor.length < 2 && !selectedBrand) {
                     container.innerHTML = "";
                     productNorsult.innerHTML = "<p class='text-muted text-center'>Pilih layanan produk anda.</p>";
                     nots.innerHTML = "";
              ...
              if (nomor && selectedBrand) {
                     ...
                     fetchProduk('emoney', selectedBrand);
              } else if (!nomor) {
                     container.innerHTML = "";
                     productNorsult.innerHTML = "";
